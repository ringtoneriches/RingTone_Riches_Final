...
>
  ...
  <div className="relative flex items-center justify-center gap-2.5">
    ...
    <ChevronRight className="w-4 h-4 text-amber-400/50 group-hover:text-amber-400 group-hover:translate-x-0.5 transition-all duration-300" />
              ...
              <div className="lg:col-span-5" id="games-section">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2.5">
                        <div className="w-9 h-9 rounded-xl flex items-center justify-center" style={{ 
                          background: 'linear-gradient(135deg, rgba(245,215,110,0.2), rgba(239,68,68,0.15))', 
                          border: '1px solid rgba(245,215,110,0.3)' 
                        }}>
                          <Flame className="w-5 h-5" style={{ color: '#f5d76e' }} />
                        </div>
                        <div>
                          <h3 className="text-base font-black tracking-tight leading-none text-white">Pick Your Winner</h3>
                      ...
                      <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full" style={{ 
                        background: 'linear-gradient(135deg, rgba(245,215,110,0.12), rgba(239,68,68,0.08))', 
                        border: '1px solid rgba(245,215,110,0.2)' 
                      }}>
                        <span className="text-[10px] font-black uppercase tracking-wider text-amber-400">4 Games</span>
                      </div>
                    </div>
                  </div>
      ...
      <div className="absolute bottom-0 left-3 right-3 h-[1px] sm:h-[2px] rounded-full bg-gradient-to-r from-transparent via-white/20 to-transparent" />
                  ...
                  <div className="px-3 pb-3">
                    <Button 
                      ...
                      className="w-full h-10 text-xs font-bold rounded-xl transition-all duration-200 hover:scale-[1.02] uppercase tracking-wider text-amber-400/70 border border-amber-400/10"
