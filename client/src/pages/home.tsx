...
export default function Home() {
  ...
  const newsletterSubscribeMutation = useMutation({
    mutationFn: async (email: string) => {
      const res = await apiRequest("/api/user/newsletter/subscribe", "POST", {
        email,
      });
      return res.json();
    },
    ...
    <div className="min-h-screen bg-[#0a0008] text-foreground relative overflow-x-hidden">
      ...
      <section className="relative min-h-screen overflow-hidden bg-[#0a0008]">
        ...
        <div className="absolute inset-0 pointer-events-none">
          {/* Deep base */}
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,#120010_0%,#0a0008_50%,#000_100%)]" />

          {/* Golden spotlight from top */}
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_60%_at_50%_-20%,rgba(225,29,72,0.25),transparent_70%)]" />

          {/* Animated glow orbs */}
          <div className="absolute top-[20%] left-[10%] w-96 h-96 rounded-full bg-rose-500/10 blur-[100px] animate-pulse" />
          <div
            className="absolute bottom-[10%] right-[10%] w-72 h-72 rounded-full bg-pink-500/8 blur-[80px] animate-pulse"
            style={{ animationDelay: "1s" }}
          />
          <div
            className="absolute top-[50%] right-[20%] w-64 h-64 rounded-full bg-red-400/6 blur-[60px] animate-pulse"
          ...
          <div
            ...
            style={{
              backgroundImage: `linear-gradient(rgba(225,29,72,0.2) 1px, transparent 1px), linear-gradient(90deg, rgba(225,29,72,0.2) 1px, transparent 1px)`,
        ...
        <div className="relative z-10 px-4 py-6 sm:py-8">
          <div className="w-full max-w-7xl mx-auto">
            ...
            <div className="text-center mb-8 sm:mb-12 animate-fade-up">
              ...
              <div className="inline-flex items-center gap-1 sm:gap-2 px-4 sm:px-6 py-2 sm:py-3 rounded-full bg-gradient-to-r from-rose-500/20 via-pink-500/15 to-rose-500/20 border border-rose-500/40 backdrop-blur-sm mb-6">
                <span className="text-rose-400 font-black text-sm sm:text-base tracking-wide">
                  LOVE
                </span>
                <span className="text-white/30">•</span>
                <span className="text-pink-300 font-black text-sm sm:text-base tracking-wide">
                  WIN
                </span>
                <span className="text-white/30">•</span>
                <span className="text-red-300 font-black text-sm sm:text-base tracking-wide">
                  CELEBRATE
                </span>
              </div>
            ...
            <div className="grid lg:grid-cols-12 gap-6 lg:gap-8 mb-8">
              ...
              <div className="lg:col-span-8 animate-fade-up-delay-1">
                <div className="relative">
                  ...
                  <div className="absolute -inset-8 rounded-3xl bg-gradient-to-br from-rose-500/30 via-pink-500/20 to-red-500/10 blur-3xl" />

                  {/* Hero Image Container - Large and Impactful */}
                  <div className="relative z-10">
                    {/* Outer glow ring */}
                    <div className="absolute -inset-3 rounded-3xl bg-gradient-to-r from-rose-500/50 via-pink-400/30 to-rose-500/50 blur-xl" />

                    {/* Premium frame */}
                    <div className="relative rounded-2xl overflow-hidden border-2 border-rose-500/60 shadow-[0_0_100px_rgba(225,29,72,0.5)]">
                ...
                <div className="grid grid-cols-3 gap-3 mt-6">
                  <div className="text-center p-4 rounded-xl bg-gradient-to-br from-rose-500/15 to-rose-600/5 border border-rose-500/30">
                    <div className="text-3xl sm:text-4xl font-black animate-text-shimmer">
                      £20K+
                    </div>
                    <div className="text-rose-400/80 text-xs uppercase tracking-wider font-bold mt-1">
                      Weekly Prizes
                    </div>
                  </div>
                  <div className="text-center p-4 rounded-xl bg-gradient-to-br from-pink-500/15 to-pink-600/5 border border-pink-500/30">
                    <div className="text-3xl sm:text-4xl font-black text-pink-400">
                      1000+
                    </div>
                    <div className="text-pink-400/80 text-xs uppercase tracking-wider font-bold mt-1">
                      Winners
                    </div>
                  </div>
                  <div className="text-center p-4 rounded-xl bg-gradient-to-br from-red-400/15 to-red-500/5 border border-red-400/30">
                    <div className="text-3xl sm:text-4xl font-black text-red-400">
                      99p
                    </div>
                    <div className="text-red-400/80 text-xs uppercase tracking-wider font-bold mt-1">
                      From Only
                    </div>
                  </div>
                </div>
                ...
                <div className="text-center mt-6">
                  <Button
                    onClick={() => {
                      const section =
                        document.getElementById("competitions-grid");
                      if (section) {
                        const elementTop =
                    ...
                    className="h-14 px-12 text-lg font-black rounded-full bg-gradient-to-r from-rose-500 via-pink-400 to-rose-500 text-white border-0 shadow-[0_0_60px_rgba(225,29,72,0.6)] hover:shadow-[0_0_80px_rgba(225,29,72,0.8)] hover:scale-105 transition-all"
              ...
              <div className="lg:col-span-4 animate-fade-up-delay-2">
                ...
                <div className="relative rounded-xl sm:rounded-2xl p-[2px] bg-gradient-to-r from-rose-500 via-pink-500 to-red-500 animate-gradient-x">
                  <div className="absolute inset-0 rounded-xl sm:rounded-2xl bg-gradient-to-r from-rose-500 via-pink-500 to-red-500 blur-lg sm:blur-xl opacity-40 sm:opacity-50 animate-gradient-x" />

                  <div className="relative rounded-xl sm:rounded-2xl bg-[#0a0008] p-3 sm:p-5 overflow-hidden">
                    {/* Floating orbs - hidden on mobile for performance */}
                    <div className="hidden sm:block absolute top-4 right-4 w-20 h-20 bg-rose-500/20 rounded-full blur-2xl animate-pulse" />
                    <div className="hidden sm:block absolute bottom-4 left-4 w-16 h-16 bg-pink-500/20 rounded-full blur-2xl animate-pulse delay-500" />

                    {/* Header with live indicator */}
                    <div className="relative text-center mb-4 sm:mb-6">
                      <div className="inline-flex items-center gap-2 sm:gap-3 px-3 sm:px-5 py-1.5 sm:py-2.5 rounded-full bg-gradient-to-r from-rose-500/20 via-pink-500/20 to-red-500/20 border border-rose-500/40 mb-2 sm:mb-4 animate-pulse">
                        <div className="w-2 h-2 sm:w-2.5 sm:h-2.5 bg-red-500 rounded-full animate-ping" />
                        <span className="text-red-400 text-xs sm:text-sm font-black tracking-wider">
                          LIVE NOW
                        </span>
                    ...
                    <div className="relative space-y-2.5 sm:space-y-4">
                      {[
                        ...
                        },
                        {
                          ...
                          gradient:
                            "from-rose-600 via-pink-500 to-rose-600",
                          borderColor: "border-rose-400/50",
                          glowColor: "shadow-rose-500/50",
                          filter: "all",
                          winChance: "HOT",
                        ...
                        >
                          {/* Inner card */}
                          <div
                            className={`relative rounded-lg sm:rounded-xl bg-slate-900/90 backdrop-blur-sm p-2.5 sm:p-4 border ${game.borderColor}`}
                          >
                            {/* Badge */}
                            <div
                              className={`absolute -top-1.5 -right-1.5 sm:-top-2 sm:-right-2 ${game.badgeColor} text-white text-[8px] sm:text-[10px] font-black px-1.5 sm:px-2.5 py-0.5 sm:py-1 rounded-full shadow-lg`}
                            >
                              {game.badge}
                            </div>
                            ...
                            <div className="relative flex items-center gap-2.5 sm:gap-4">
                              {/* Glowing Icon */}
                              <div
                                className={`relative w-10 h-10 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl bg-gradient-to-br ${game.gradient} flex items-center justify-center shadow-lg sm:shadow-xl shrink-0`}
                              >
                              ...
                              <div className="flex-1 text-left min-w-0">
                                <div className="text-white font-black text-sm sm:text-lg mb-0 sm:mb-0.5 truncate">
                                  {game.title}
                                </div>
                                <div className="text-white/70 text-[10px] sm:text-xs font-medium mb-0.5 sm:mb-1">
                                  {game.tagline}
                                </div>
                                {/* Stars Rating */}
                                <div className="flex items-center gap-0.5">
                                  {[...Array(5)].map((_, i) => (
                                    <Star
                                      key={i}
                                      className={`w-2.5 h-2.5 sm:w-3 sm:h-3 ${i < game.stars ? "text-rose-400 fill-rose-400" : "text-white/20"}`}
                                    />
                                  ))}
                                  <span className="text-rose-400 text-[9px] sm:text-[10px] font-bold ml-1">
                                    {game.winChance}
                                  </span>
                                </div>
                              </div>
                              ...
                              <div className="text-right shrink-0">
                                <div className="text-white/50 text-[8px] sm:text-[10px] uppercase tracking-wider font-bold hidden sm:block">
                                  Win Up To
                                </div>
                                <div
                                  className={`text-xl sm:text-3xl font-black bg-gradient-to-r ${game.gradient} bg-clip-text text-transparent`}
                                >
                                  {game.prize}
                                </div>
                    ...
                    <div className="mt-3 sm:mt-5 pt-3 sm:pt-4 border-t border-white/10">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2 sm:gap-3">
                          <div className="flex items-center gap-1 px-2 sm:px-3 py-1 sm:py-1.5 rounded-full bg-gradient-to-r from-rose-500/20 to-pink-500/10 border border-rose-500/30">
                            <Trophy className="w-3 h-3 sm:w-4 sm:h-4 text-rose-400" />
                            <span className="text-rose-400 text-[10px] sm:text-xs font-bold">
                              Love wins here
                            </span>
                          </div>
                        </div>
                        <Button
                          ...
                          className="text-rose-400 hover:text-rose-300 font-bold h-7 sm:h-8 text-xs sm:text-sm px-2 sm:px-3"
      ...
      <section className="relative py-8 sm:py-12 bg-[#0a0008]">
      ...
      {/* Modern Filter Tabs */}
      <section className="glass-modern sticky top-0 z-40 backdrop-blur-xl bg-slate-900/90 border-b border-rose-500/20">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
    <div className="text-center mb-3">
      <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gradient-to-r from-rose-500/10 to-pink-500/5 border border-rose-500/30">
        <Heart className="w-4 h-4 text-rose-400 fill-rose-400" />
        <span className="text-rose-400 text-sm font-bold tracking-wide">
          WIN WITH LOVE
        </span>
        <Heart className="w-4 h-4 text-rose-400 fill-rose-400" />
      </div>
    ...
    <div className="flex flex-wrap justify-center gap-2 sm:gap-3">
      {[
        ...
        { id: "scratch", label: "Scratch Love", icon: Sparkles },
        { id: "instant", label: "Competition", icon: Gift },
      ].map((filter) => (
        <button
          key={filter.id}
          onClick={() => handleFilterChange(filter.id)}
          className={`group relative px-5 sm:px-6 py-3 rounded-full font-bold text-sm transition-all duration-300 flex items-center gap-2 ${
            activeFilter === filter.id
              ? "bg-gradient-to-r from-rose-500 via-pink-400 to-rose-500 text-white shadow-[0_0_30px_rgba(225,29,72,0.5)]"
              : "bg-gradient-to-b from-rose-500/10 to-transparent text-rose-300/80 border border-rose-500/20 hover:border-rose-500/40 hover:text-white hover:shadow-[0_0_20px_rgba(225,29,72,0.2)]"
          }`}
          data-testid={`button-filter-${filter.id}`}
        >
          {/* Icon with shine effect */}
          <div className="relative">
            <filter.icon className={`w-4 h-4 transition-transform ${
              activeFilter === filter.id 
                ? "scale-110" 
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-[#0a0008] relative">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_50%_at_50%_-20%,rgba(225,29,72,0.06),transparent)]" />
        ...
        <section className="py-12 md:py-20 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-2xl mx-auto relative">
              ...
              <div className="absolute -inset-1 bg-gradient-to-r from-rose-500 via-pink-400 to-rose-600 rounded-3xl blur-sm opacity-60" />
                ...
                {user?.receiveNewsletter ? (
                  ...
                  >
                    <div className="relative group">
                      <div className="absolute -inset-0.5 bg-gradient-to-r from-rose-500 to-pink-500 rounded-xl blur opacity-30 group-hover:opacity-50 transition" />
                      <div className="relative">
                        <Input
                          type="email"
                          ...
                          className="bg-slate-700/80 border-slate-600 text-white placeholder:text-slate-400 h-14 md:h-16 text-base md:text-lg pl-14 pr-4 rounded-xl focus:border-rose-400 focus:ring-2 focus:ring-rose-400/50"
  ...
  className="relative w-full h-14 md:h-16 rounded-xl font-black text-lg md:text-xl overflow-hidden transform transition-all duration-300 hover:scale-[1.03] border border-rose-300/30"
>
  {/* Glow */}
