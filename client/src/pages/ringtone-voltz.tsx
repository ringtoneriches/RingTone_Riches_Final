      ...
      <section className="bg-card border-y border-border">
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-wrap justify-center gap-4">
            {["all", "spin", "scratch", "pop", "voltz", "instant"].map((type) => (
              <button
                key={type}
      ...
      <section className="py-8 bg-gradient-to-b from-background to-card">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Flip the switches and surge the power! Choose a switch to trigger
            an electricity surge for a chance to win instant cash or ringtone points!
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 text-center">
          {voltzCompetitions.length > 0 ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-xl text-muted-foreground mb-2">No Ringtone Voltz games available yet.</p>
