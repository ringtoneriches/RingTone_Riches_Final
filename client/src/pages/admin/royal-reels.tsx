    ...
    <div className="space-y-4 max-h-[70vh] overflow-y-auto pr-1 sm:pr-2">
      <div>
        ...
        <Input
          ...
          placeholder="Royal Reels Game Title"
      ...
      <div>
        ...
        <Textarea
          ...
          placeholder="Description for Royal Reels game..."
          rows={4}
      ...
      <div>
        ...
        <p className="text-xs text-muted-foreground mt-1">
          Premium slot game with 19 prize tiers, Royal Replay feature, and cash/points rewards
        </p>
      </div>
      ...
      <DialogFooter className="mt-6">
        ...
        >
          {isLoading ? "Saving..." : "Save Royal Game"}
        </Button>
      </DialogFooter>
    </div>
  );
...
export default function AdminRoyalReels() {
  const { toast } = useToast();
  ...
  const competitions = allCompetitions?.filter((c) => c.type === "royal") || [];
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({ title: "Royal Reels game created successfully" });
    },
    onError: (error: any) => {
      toast({
        title: "Failed to create Royal Reels game",
        description: error.message,
        variant: "destructive",
      });
    },
  ...
  const updateMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({ title: "Royal Reels game updated successfully" });
    },
    onError: (error: any) => {
      toast({
        title: "Failed to update Royal Reels game",
        description: error.message,
        variant: "destructive",
      });
    },
  ...
  const archiveMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({ title: "Royal Reels game archived successfully" });
    },
    onError: (error: any) => {
      toast({
        title: "Failed to archive Royal Reels game",
        description: error.message,
        variant: "destructive",
      });
    },
  ...
  const unarchiveMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({ title: "Royal Reels game unarchived successfully" });
    },
    onError: (error: any) => {
      toast({
        title: "Failed to unarchive Royal Reels game",
        description: error.message,
        variant: "destructive",
      });
    },
      ...
      <div className="space-y-4 md:space-y-6">
        <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
          <div>
            <h1
              ...
              data-testid="heading-royal-reels"
            >
              Royal Reels Games
            </h1>
            <p className="text-sm md:text-base text-muted-foreground mt-1">
              Manage your Royal Reels games
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            ...
            <div className="flex gap-2">
              <Link to="/admin/royal-reels/settings">
                <Button
                  variant="outline"
                  className="gap-2"
                  data-testid="button-royal-settings"
                >
              ...
              <Button
                ...
                data-testid="button-create-royal"
              >
            ...
            {activeCompetitions.length === 0 ? (
              <div className="text-center py-12 border border-dashed rounded-lg">
                <p className="text-muted-foreground mb-4">
                  No active Royal Reels games yet
                </p>
              </div>
            ) : (
          ...
          <DialogContent className="max-w-7xl max-h-[80vh] overflow-y-auto">
            <DialogHeader>
              <DialogTitle className="flex items-center gap-2">
                ...
                Archived Royal Reels Games ({archivedCompetitions.length})
              </DialogTitle>
            </DialogHeader>
            ...
            <div className="space-y-4 py-4">
              {archivedCompetitions.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-muted-foreground">No archived Royal Reels games</p>
                </div>
              ) : (
        ...
        <Dialog open={createDialogOpen} onOpenChange={setCreateDialogOpen}>
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              <DialogTitle>Create New Royal Reels Game</DialogTitle>
            </DialogHeader>
            <CompetitionForm
        ...
        >
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              <DialogTitle>Edit Royal Reels Game</DialogTitle>
            </DialogHeader>
            {editingCompetition && (
              <CompetitionForm
        ...
        >
          <DialogContent className="w-[90vw] max-w-sm sm:max-w-md mx-auto">
            <DialogHeader>
              <DialogTitle>Archive Royal Reels Game</DialogTitle>
            </DialogHeader>
            <p className="text-muted-foreground">
              Are you sure you want to archive this Royal Reels game? Archived games will become inactive and won't be shown on the frontend.
            </p>
            <DialogFooter>
              <Button
                variant="outline"
        ...
        >
          <DialogContent className="w-[90vw] max-w-sm sm:max-w-md mx-auto">
            <DialogHeader>
              <DialogTitle>Unarchive Royal Reels Game</DialogTitle>
            </DialogHeader>
            <p className="text-muted-foreground">
              Are you sure you want to unarchive this Royal Reels game? The game will become active and will be shown on the frontend.
            </p>
            <DialogFooter>
              <Button
                variant="outline"
