...
function CompetitionForm({
  ...
  const [form, setForm] = useState<CompetitionFormData>({
    ...
    badgeLabel: data?.badgeLabel || getDefaultBadgeLabel("slot"),
  ...
  return (
    <div className="space-y-4 max-h-[70vh] overflow-y-auto pr-1 sm:pr-2">
      ...
      <div>
        <Label>Game Image (Slot Machine Background)</Label>
        <div className="space-y-2">
          <div className="flex gap-2">
            ...
            >
              ...
              {uploading ? "Uploading..." : "Select Slot Machine Image"}
            </Button>
          </div>
          {form.imageUrl && (
      ...
      <div>
        ...
        <p className="text-xs text-muted-foreground mt-1">
          Uses slot machine prize configuration with spinning reels
        </p>
      </div>
...
export default function AdminSlotGame() {
  const { toast } = useToast();
  ...
  const createMutation = useMutation({
    mutationFn: async (formData: CompetitionFormData) => {
      const payload: any = {
        ...
        badgeLabel: serializeBadgeLabel(formData.badgeLabel, "slot"),
  ...
  const updateMutation = useMutation({
    mutationFn: async ({
      ...
      const payload: any = {
        ...
        badgeLabel: serializeBadgeLabel(data.badgeLabel, "slot"),
        ...
        <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
          <div>
            <h1
              ...
              data-testid="heading-slot-game"
            >
              🎰 Slot Machine Games
            </h1>
            <p className="text-sm md:text-base text-muted-foreground mt-1">
              Manage your slot machine games with spinning reels
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            ...
            <div className="flex gap-2">
              <Link to="/admin/slot-game/settings">
                <Button
                  variant="outline"
                  className="gap-2"
