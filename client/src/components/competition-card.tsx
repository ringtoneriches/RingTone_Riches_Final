    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, rgba(225,29,72,0.5) 0%, rgba(255,255,255,0.15) 50%, rgba(225,29,72,0.3) 100%)",
          }}
        >
          {/* Inner Card */}
          <div
            ...
            style={{
              boxShadow:
                "inset 0 1px 0 rgba(255,255,255,0.08), 0 20px 50px -15px rgba(0,0,0,0.7)",
            }}
          >
            {/* Image Section */}
            ...
            <div className="p-2 sm:p-3 flex flex-col gap-2 bg-gradient-to-b from-slate-800/50 to-slate-900/80">
              {/* Title - Full text */}
              <h3
                className="text-xs sm:text-sm font-bold text-white leading-snug group-hover:text-rose-400 transition-colors"
              ...
              <div className="flex items-center justify-between gap-2 pt-2 border-t border-slate-700/50">
                ...
                <Button
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, #e11d48 0%, #ff4d6d 50%, #e11d48 100%)",
            ...
            {/* Top edge highlight */}
            <div className="absolute top-0 left-[15%] right-[15%] h-px bg-gradient-to-r from-transparent via-rose-400/50 to-transparent" />
          </div>
        </div>
      </div>
    </div>
